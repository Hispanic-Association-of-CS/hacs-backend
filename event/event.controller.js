...
exports.create = async (path, body, firebaseAdmin) => {
  ...
  return firebaseAdmin.adminDB.ref(`events/${id}`).set({ ...body, uid: id });
  // TODO: Allow returning of event for successful creation?
};

exports.update = async (path, id, body, firebaseAdmin) =>
  firebaseAdmin.adminDB.ref(`events/${id}`).set(body);
// TODO: Allow returning of event for successful update?
